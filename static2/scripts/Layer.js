...
lu.Layer.prototype.click = function(e){
    ...
    console.log(this.ID + ' received click');
};
...
lu.Layer.prototype.serializeBlocks = function(){
    ...
    goog.array.forEach(this.luBlocks, function(block, index) {
        ...
        if(!block.isDeleted)
        {
            ...
            console.log('block no: ' + index + ' end');
            IDcounter++;
        }
    });
    console.log('layer ' + this.ID + ' serialized a block');
    return blockArray;
};
...
{
    console.log('layer ready to clone');

...
lu.LayerProperties = function() {
    ...
    this.instructionBox = new lime.Label('click to edit instruction',20).setSize(300,40).setPadding(10)
...
// lu.LayerProperties.prototype.setupMultiLabelEvents = function(){
//     propDialog = this;
//     for (j = 0; j<this.multiLabels.length; j++)
//     {
//     	console.log('making events');
//         (function (j,propDialog) {
//             goog.events.listen(propDialog.multiLabels[j], ['mousedown', 'touchstart'], function(e)
//         	{

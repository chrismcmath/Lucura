...
cu.PointsPanel = function() {
	...
	this.roundPointsLabel = new lime.Label().setSize(50,50).setText('0').setPosition(13,-30).setFontSize(80).setFontFamily('lot').setAnchorPoint(0,1).setFontColor('#FFEE6D');
	this.gamePointsLabel = new lime.Label().setSize(50,50).setText('0').setPosition(95,-25).setFontSize(40).setFontFamily('lot').setFontColor('#387071').setAnchorPoint(0.5,0.5);
	this.failTallyLabel = new lime.Label().setSize(50,50).setText('0').setPosition(135,-25).setFontSize(40).setFontFamily('lot').setFontColor('#AF3442').setAnchorPoint(0.5,0.5);
...
cu.PointsPanel.prototype.endGameDisplay = function()
{
	...
	dash = new lime.Sprite().setSize(25,10).setFill('#fff').setPosition(82,-50).setOpacity(0);
	passed = new lime.Label("passed",20).setFontColor('#387071').setFontFamily('lot').setPosition(45,-15).setOpacity(0);
	failed = new lime.Label("failed",20).setFontColor('#AF3442').setFontFamily('lot').setPosition(115,-15).setOpacity(0);
	...
	movePoints = function(){
		...
		this.failTallyLabel.runAction(new lime.animation.MoveTo(this.failTallyLabel.getPosition().x-20, this.failTallyLabel.getPosition().y-20));
	};

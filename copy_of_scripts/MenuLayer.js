...
var fadeGrad = new lime.fill.LinearGradient().
    ...
    this.inputFields[0] = new builder.Label(180,100).setAnchorPoint(0,0).setPosition(10,50).setFontFamily('miso-bold').
    ...
    this.inputFields[1] = new builder.Label(255,100).setAnchorPoint(0,0).setPosition(10,50).setFontFamily('miso-bold').

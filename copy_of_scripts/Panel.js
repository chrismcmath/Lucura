...
lu.Panel = function(x,y) {
	...
	lilIcon = new lime.Label('New',20).setSize(20,20)
        .setFontFamily('impact').setFontColor('#a90329').setFontSize(25)
        .setPosition(TILE_WIDTH/2-8,TILE_HEIGHT/2);
    lilIconBack = new lime.Label('New',20).setSize(20,20)
        .setFontFamily('impact').setFontColor('#6d0019').setFontSize(25)
        .setPosition(TILE_WIDTH/2-10,TILE_HEIGHT/2-2);
